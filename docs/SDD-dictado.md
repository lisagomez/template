...
| (b) dictar en cualquier app de Windows | lo mismo: el pegador no sabe qué ventana es | <!-- CASO_B -->**pendiente**: la misma prueba con el cursor en otra app de Windows (Bloc de notas u otra)<!-- /CASO_B --> |
