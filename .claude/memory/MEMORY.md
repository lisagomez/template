...
- [Material de origen de la gobernanza](reference/material-origen-gobernanza.md) — los 9 docs de Hermes OS: que se conservo y que no. Ruta no disponible en esta maquina.
- [Entorno: que se puede y que no](reference/entorno-git-y-red.md) — ESTA maquina (2026-08-26): `gh` como HuertaVictor, Node 22, Docker si, Go viejo, sin sudo ni Supabase.
