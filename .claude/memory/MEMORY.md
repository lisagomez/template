...
- [Capa de gobernanza agentica](project/gobernanza-agentica.md) — adoptada y firmada 2026-08-23; capa B con 5 mediciones validas en frio, todas verdes; verificador 113/113. Distingue deuda del template vs del entorno.
...
- [Eficiencia de tokens y frescura de versiones](project/eficiencia-tokens.md) — los cuatro sensores (contexto, routing, contabilidad, frescura) construidos y en el gate; falta `.claude/rules/` y una corrida real de opencode.
