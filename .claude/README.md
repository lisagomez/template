...
Los 26 skills son invocables con `/nombre` y activables por Claude segun
...
```bash
npm run verify:gobernanza   # 152 comprobaciones (la cifra la vigila el propio verificador)
...
```
.claude/
├── skills/                    # Skills 2.0 (V4) - 26 skills
